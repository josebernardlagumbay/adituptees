	...
	<div class="row padding_top15">
		<div class="span6">
			<ul class="nav nav-pills">
				<li class="active"><a href="<?php echo current_url() ?>">Add Web Content for <?php echo $web_content[0]['web_content_name'] ?></a></li>
			</ul>
		</div>
	</div>
</div>
	...
	<div class="container padding_top15">
		<div class="row">
			<div class="span12">
				...
				<form name="frmWebcontent" id="frmWebcontent" method="POST" action="<?php echo site_url('web_content/save-content'); ?>" enctype="multipart/form-data">
    				...
    				<br />
    				<div>
    				    <button type="submit" class="btn btn-info" name="cmdSave" id="cmdSave">Save Content for <?php echo $web_content[0]['web_content_name'] ?></button>
    				</div>
				</form>
			</div>
		</div>
