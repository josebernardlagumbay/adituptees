	...
	<div class="row padding_top15">
		<div class="span6">
			<ul class="nav nav-pills">
				...
				<li class="active"><a href="<?php echo site_url('product_type/add') ?>">Add Product Type</a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="background1">
	<div class="container padding_top15">
		<div class="row">
			<div class="span12">
				<div class="content_header">Add Product Type</div>
				<div class="padding_top15">
					<form class="form-horizontal" id="frmProducttype" name="frmProducttype" enctype="multipart/form-data" method="post">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="product_type_name" name="product_type_name" placeholder="Product Type Name">
							</div>
						</div>
						<div class="control-group">
	...
	(
		function()
		{
			...
			if(error == 1){
				...
				$.post
				(
					'<?php echo site_url("product_type/save") ?>',
					{
