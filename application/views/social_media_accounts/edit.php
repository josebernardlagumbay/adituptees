	...
	<div class="row padding_top15">
		<div class="span6">
			<ul class="nav nav-pills">
				...
				<li class="active"><a href="<?php echo site_url('social_media_accounts/add') ?>">Add Social Media Account</a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="background1">
	<div class="container padding_top15">
		<div class="row">
			<div class="span12">
				<div class="content_header">Edit Social Media Account</div>
				<div class="padding_top15">
					<form class="form-horizontal" id="frmSocialMedia" name="frmSocialMedia" enctype="multipart/form-data" method="post" action="<?php echo site_url('social_media_accounts/update'); ?>">
						<input type="hidden" name="social_id" id="social_id" value="<?php echo $this->uri->segment(3) ?>"/>
						<div class="control-group">
							<label class="control-label" for="inputURL"><span class="required">*</span>&nbsp;Social Media URL</label>
							<div class="controls">
								<div><input type="text" id="social_media_url" name="social_media_url" placeholder="URL" value="<?php echo $social_media[0]['url'] ?>"></div>
						...
						<div class="control-group">
							...
							<div class="controls"><input type="text" id="social_media_name" name="social_media_name" placeholder="Name" value="<?php echo $social_media[0]['name'] ?>"></div>
						</div>
						<div class="control-group">
							<label class="control-label" for="inputLogo">Social Media Logo</label>
