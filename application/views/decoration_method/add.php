	...
	<div class="row padding_top15">
		<div class="span6">
			<ul class="nav nav-pills">
				...
				<li class="active"><a href="<?php echo site_url('decoration/add') ?>">Add Decoration Method</a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="background1">
	<div class="container padding_top15">
		<div class="row">
			<div class="span12">
				<div class="content_header">Add Product Decoration Method</div>
				<div class="padding_top15">
					<form class="form-horizontal" id="frmDecorationmethod" name="frmDecorationmethod" enctype="multipart/form-data" method="post">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="decoration_method_name" name="decoration_method_name" placeholder="Decoration Method Name">
							</div>
						</div>
						<div class="control-group">
	...
	(
		function()
		{
			...
			if(error == 1){
				...
				$.post
				(
					'<?php echo site_url("decoration/save") ?>',
					{
