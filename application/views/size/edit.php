...
<div class="background1">
	<div class="container padding_top15">
		<div class="row">
			<div class="span12">
				<div class="content_header">Edit Product Size</div>
				<div class="padding_top15">
					<form class="form-horizontal" id="frmSize" name="frmSize" enctype="multipart/form-data" method="post">
						<input type="hidden" name="size_id" id="size_id" value="<?php echo $this->uri->segment(3) ?>"/>
						<div class="control-group">
							<label class="control-label" for="size_name"><span class="required">*</span>&nbsp;Size Name</label>
							<div class="controls">
								<input type="text" id="size_name" name="size_name" placeholder="Size Name" value="<?php echo $size[0]['size_name'] ?>">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="add_on_amount"><span class="required">*</span>&nbsp;Add On Amount <?php echo $currency[0]['data'] ?></label>
							<div class="controls">
								<input type="text" id="add_on_amount" name="add_on_amount" placeholder="Add On Amount" value="<?php echo $size[0]['add_on_amount'] ?>">
							</div>
						</div>
						<div class="control-group">
...
<script type="text/javascript">
	...
	{
		window.location = '<?php echo site_url("size/view-sizes") ?>';
	}
