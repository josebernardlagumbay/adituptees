		<div class="bar_header color1">
			<div class="content_header">&nbsp;&nbsp;Edit Color</div>
		</div>
			...
			<div style="margin-left: 5px;">
				...
				<div class="row">
					<div class="span6">
						...
						<form name="frmColor" id="frmColor" method="POST" method="POST" action="<?php echo site_url('color/update/'.$this->uri->segment(3)); ?>" enctype="multipart/form-data">
							<div>
								<label>Color:</label>
								<input type="text" name="color_name" id="color_name" value="<?php echo $color[0]['color_name'] ?>"/>
							</div>
							<br />
							<div>
			...
			if(error == 1){
				...
				(
					'<?php echo site_url("color/is_exist"); ?>',
					{
						...
						key: '<?php echo $this->uri->segment(3); ?>'
					},
					function(data)
					{
						if(data == 'EXIST'){
